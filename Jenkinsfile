pipeline {
  ...
  stage ('build code  ') {
      steps {
    	        sh " sudo cp * /home/ansible1/Calculator-App-Python/ && cd /home/ansible1/Calculator-App-Python/calculator && source bin/activate && cd .. &&  pip install -r requirements.txt"
      }} 
