pipeline {
  ...
  stage ('build code  ') {
      steps {
    	        sh " sudo scp * /home/ansible1/Calculator-App-Python/Calculater-App-Python/ && cd /home/ansible1/Calculator-App-Python/Calculater-App-Python/calculator && source bin/activate && cd .. &&  pip install -r requirements.txt"
      }} 
